...
st.sidebar.markdown("")  
st.sidebar.markdown("---")  
st.sidebar.markdown("📌 **Shell, Chevron, BP**의 **General Terms and Conditions**(이하 GT&C)는 석유 제품 거래의 기본 조건을 규정하며, 주로 인도, 결제, 위험 이전 등을 다룹니다.")
...
st.sidebar.markdown("`Lawbot AI는 실수를 할 수 있습니다. 중요한 정보를 확인하세요`")
