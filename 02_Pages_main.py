...
st.sidebar.markdown("💡 **계약 관련 업무 및 교육 지원**")
st.sidebar.markdown("")  
st.sidebar.markdown("---")  
st.sidebar.markdown("📌 Shell, Chevron, BP 등의 **General Terms and Conditions**(GT&C)는 석유 거래의 기본 조건을 규정하며, 주로 인도, 결제, 위험 이전 등을 다룹니다.")
